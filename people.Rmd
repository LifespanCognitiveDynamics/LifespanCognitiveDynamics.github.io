...
knitr::include_graphics("images/people/BUstun- headshot_c.png")
```
...
<i class="fab fa-linkedin-in"></i>[ LinkedIn](www.linkedin.com/in/beyza-ustun-elayan)
<i class="fas fa-envelope"></i>[  Beyza.ustun-elayan@radboudumc.nl](Beyza.ustun-elayan@radboudumc.nl)
<i class="ai ai-google-scholar"></i>[  google scholar](https://scholar.google.com/citations?user=bsf-p0MAAAAJ&hl=en)
<i class="ai ai-orcid"></i>[  ORCID](https://orcid.org/0000-0002-8591-5001)

I am a postdoctoral researcher at the Donders Institute and a Visiting Research Associate in the Department of Psychology at the University of Cambridge. My research focuses on how the first 1,000 days of life shape long-term health and development, with an emphasis on sensory and cognitive development.
At the LCD Lab, I work on the global LEVANTE Project, examining cognitive variability in children and how early-life factors—from pregnancy onwards—shape developmental trajectories. I am also passionate about science communication and enjoy bringing research beyond the lab through public engagement. Outside of work, I enjoy sharing photos of my cat, collecting vinyl records, and travelling spontaneously.

---

```{r, out.width = "40%", fig.align = 'center', echo=FALSE}

knitr::include_graphics("images/people/AnnaBanaszkiewicz_C.png")
```
...
<i class="fas fa-envelope"></i>[Anna.Banaszkiewicz@radboudumc.nl](Anna.Banaszkiewicz@radboudumc.nl)
<i class="fas fa-envelope"></i>[a.banaszkiewicz@nencki.edu.pl](a.banaszkiewicz@nencki.edu.pl)
<i class="ai ai-google-scholar"></i>[google scholar](https://scholar.google.pl/citations?user=ocUfYqIAAAAJ&hl=pl&oi=ao)

I am a postdoc at the Laboratory of Language Neurobiology at the Nencki Institute, Warsaw, Poland, where I investigate longitudinal relationships between cognition (language, attention and social skills) and brain development in neurodiverse children.
During my research visit at the LCD lab I will conceptualize and apply a set of longitudinal structural equation models to our multivatiate behavioral and neuroimaging data. 
In my free time I enjoy being out in nature climbing, hiking or cycling, as well as listening to music. 
...
knitr::include_graphics("images/people/Feline_C.png")
```
...
I’m interested in differences in development of children with and without diagnoses. In my previous research I focused specifically on the neurobiological substrates of ADHD by means of diffusion tensor imaging. In my PhD I’ll be exploring how early life experiences influence children’s later cognitive performance. In my downtime I like to knit, read and cook new recipes. My absolute favorite activity is snowboarding!
...
<i class="fas fa-envelope"></i>[  nicholas.judd@su.se](nicholas.judd@su.se)
...
knitr::include_graphics("images/people/Larissa_C.png")
```
...
<i class="fas fa-envelope"></i>[  Larissa.Rosalia@radboudumc.nl](larissa.rosalia@radboudumc.nl)

My interests center on children’s development, particularly psychobiological and cognitive processes. I am especially drawn to understanding how environmental factors shape these developmental pathways, and whether and how these influences contribute to both intra- and interindividual differences. Outside the lab, I love getting immersed in a good story, both through reading and watching films. I also enjoy traveling to explore new places, learn about different cultures, and relax.
...
knitr::include_graphics("images/people/Kevin_C.png")
```
...
<i class="fab fa-linkedin-in"></i>[ LinkedIn]( https://www.linkedin.com/in/kevin-reniers/)
<i class="fas fa-envelope"></i>[kevin.reniers@ru.nl](kevin.reniers@ru.nl)
<i class="fa fa-github"></i>[  GitHub](https://kevin-reniers.github.io/website/)

Hi, I’m Kevin, a Research Assistant at the LCD lab. I’m interested in all neuroscience related to education, development and motivation and in the many methods we use to study them. Within the lab I’m part of the CODEC team, helping to acquire data at schools throughout the country and in the MRI scanner at the Donders. Additionally, together with other members of the lab, we are trying to build multilevel models that we can use to understand variability in children at different timescales (from trial-to-trial, session-to-session and day-to-day). We hope to create individual Variability Profiles per child, across different cognitive tasks, and see if we can link those to cognitive performance and other metrics! In my day-to-day life you can find me anywhere, reading a good book on the couch, trying out new hobbies (and quickly abandoning them, oftentimes) or moving about in the beautiful city of Nijmegen!
...
knitr::include_graphics("images/people/Rafael_C.png")
```
...
<i class="fab fa-linkedin-in"></i>[ LinkedIn](https://www.linkedin.com/in/rafael-zampakas-8a1448255/)
<i class="fas fa-envelope"></i>[rafael.zampakas@ru.nl](rafael.zampakas@ru.nl)
<i class="fab fa-bluesky"></i>[  @rafael-zam.bsky.social](https://bsky.app/profile/rafael-zam.bsky.social)



I’m fascinated by how language skills develop and enjoy combining biological and computational approaches to explore this process. As part of the CODEC team, a longitudinal study on the cognitive abilities of primary school children, my internship focuses on intraindividual language variability and its relation to other forms of cognitive variability using Dynamic Structural Equation Modeling (DSEM). Outside the lab, I love drawing inspiration from cinema and series, learning new languages, swimming, and a being a bit too active in a classical student choir.

---

```{r, out.width = "50%", fig.align = 'center', echo=FALSE}

knitr::include_graphics("images/people/Lucia_C.png")
```
...
<i class="fab fa-linkedin-in"></i>[ LinkedIn](https://www.linkedin.com/in/lucialopezsanchez)
<i class="fas fa-envelope"></i>[lucia.lopezsanchez@ru.nl](lucia.lopezsanchez@ru.nl)

I am interested in brain health and the impact of lifestyle factors on the brain across the lifespan. During my Master’s in Cognitive Neuroscience at Radboud University, I explored the longitudinal relationship between physical activity and the gut-brain axis. At the LCD Lab, I am investigating the relationship between cognitive variability and cognitive flexibility across multiple databases. Outside of the lab, I enjoy sports (especially swimming, running, and cycling), travelling, and any excuse to be outdoors and by the ocean.

---

```{r, out.width = "50%", fig.align = 'center', echo=FALSE}

knitr::include_graphics("images/people/Stijn_C.png")
```
...
<i class="fab fa-linkedin-in"></i>[ LinkedIn](https://nl.linkedin.com/in/stijn-reits-22181b300)
<i class="fas fa-envelope"></i>[stijn.reits@radboudumc.nl](stijn.reits@radboudumc.nl)
<i class="fa fa-github"></i>[  GitHub](https://github.com/StijnR7)

I’m a software development student and intern with a focus on embedded systems. My current project involves building a device to monitor classroom environmental data, with the goal of understanding how different environmental variables affect cognitive performance in children. Alongside this, I also work as an RA for the CODEC project. Outside of work, I enjoy being outdoors, lifting weights, cooking, and gaming.

---

```{r, out.width = "50%", fig.align = 'center', echo=FALSE}

knitr::include_graphics("images/people/Laurijn_C.png")
```
...
<i class="fas fa-envelope"></i>[laurijn.schimmel@radboudumc.nl](laurijn.schimmel@radboudumc.nl)

Hi, my name is Laurijn. I am currently a bachelor’s student in Biomedical Sciences at Radboud University. I am interested in the effects of environmental factors on development, particularly cognitive development, and I want to learn more about how and why cognitive abilities change throughout life. During my internship at the lab, I work within the CODEC team investigating primary school children’s cognitive performance and fluctuations. My internship focuses on the relationship between fatigue and cognitive performance and fluctuations using this dataset. In my free time, I enjoy reading, rowing, and travelling.
...
knitr::include_graphics("images/people/Lena_C.png")
```
...
I’m a Cognitive Neuroscience Master’s student interested in the cognitive and socioemotional development of children, particularly in the context of primary education. How does schooling (as considered in isolation of or in combination with age) shape the way the brain develops and the outcomes we extract with cognitive testing during this period – and how can educational policies or interventions centered on the individual support these complex processes, not only by improving cognitive performance but also by fascilitating growth in socioemotional skills?
During my internship, I’m working on CODEC, focusing mostly on the MRI side of the project. Aside from assisting in the data collection, I’m working on a pipeline to extract white matter integrity with the goal to link the parameters thereof to cognitive intravariability. I’m also interested in finding new ways to communicate our science to the children participating in the study, with the goal to have them be (almost) as excited in taking part as we are in conducting the research!
In my leisure time, I enjoy doing sports (strength training always, cycling and running mostly when it’s not raining), trying out new cooking or baking recipes, discovering Dutch cities and crafting with friends.
---
...
<i class="fas fa-envelope"></i>[ciske.jansen@radboudumc.nl](ciske.jansen@radboudumc.nl)
